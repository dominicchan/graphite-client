...
namespace Graphite
{
    ...
    public static class MetricsPipeExtensions
    {
        ...
        public static void Timing(this MetricsPipe profiler, string key, float value)
        {
            if (profiler == null)
                return;
        ...
        public static void Count(this MetricsPipe profiler, string key, float value = 1, float sampling = 1)
        {
            if (profiler == null)
                return;
        ...
        /// <param name="key">The key.</param>
        /// <param name="value">The value.</param>
        public static void Gauge(this MetricsPipe profiler, string key, float value)
        {
            if (profiler == null)
                return;
        ...
        /// <param name="value">The value.</param>
        public static void Raw(this MetricsPipe profiler, string key, float value)
        {
            if (profiler == null)
                return;
